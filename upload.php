          ...
          Dropzone.autoDiscover = false;
            $(".dropzone").dropzone({
                ...
                success:  function() {
                    ...
                    $('.upload-zone').append("<p>Visit your new resume page: </p><a style='display:inline;' href='resume.php?resumeId="+my_path+"' >roastmyresume.com/resume.html?resumeId="+my_path+"</a>");
